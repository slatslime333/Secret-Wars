...
const KEYS: Record<string, string> = {
  ...
  'tree:small': 'sw-tree-small-v5',
  'tree:medium': 'sw-tree-medium-v5',
  'tree:broad': 'sw-tree-broad-v5',
  'crate:single': 'sw-crate-single-v4',
  'crate:stack': 'sw-crate-stack-v4',
  'crate:pair': 'sw-crate-pair-v4',
  'building:house': 'sw-building-house-v6',
  'building:house-floor': 'sw-building-house-floor-v2',
  'building:house-roof': 'sw-building-house-roof-v2',
  'building:house-shell': 'sw-building-house-shell-v2',
  ...
  'building:shop': 'sw-building-shop-v2',
  'building:shop-floor': 'sw-building-shop-floor-v2',
  'building:shop-roof': 'sw-building-shop-roof-v2',
  'building:shop-shell': 'sw-building-shop-shell-v2',
  ...
  'barrel:drum': 'sw-barrel-drum-v2',
  'barrel:fuel': 'sw-barrel-fuel-v2',
  'barrel:skull': 'sw-barrel-skull-v1',
  'lamp:street': 'sw-lamp-street-v1',
  'lamp:short': 'sw-lamp-short-v1',
